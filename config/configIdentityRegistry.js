...
const SYSTEM_CONFIG_CATEGORY_IDS = Object.freeze({
  ...
  YES_NO_OPTIONS: 34,
  TEST_RESULTS: 35,
  AVAILABILITY_TEST_RESULTS: 36,
  LOCK_STATUSES: 37,
  DISPLAY_TYPES: 38,
  SCREEN_RESOLUTIONS: 39,
  REFRESH_RATES: 40,
  COLORS: 41,
  CAMERA_TYPES: 42,
  CAMERA_LOCATIONS: 43,
...
const CATEGORY_BINDINGS = Object.freeze([
  ...
  [SYSTEM_CONFIG_CATEGORY_IDS.SCREEN_SIZES, 'Screen Sizes', []],
  [SYSTEM_CONFIG_CATEGORY_IDS.YES_NO_OPTIONS, 'Yes / No Options', []],
  [SYSTEM_CONFIG_CATEGORY_IDS.TEST_RESULTS, 'Test Results', []],
  [SYSTEM_CONFIG_CATEGORY_IDS.AVAILABILITY_TEST_RESULTS, 'Availability Test Results', []],
  [SYSTEM_CONFIG_CATEGORY_IDS.LOCK_STATUSES, 'Lock Statuses', []],
  [SYSTEM_CONFIG_CATEGORY_IDS.DISPLAY_TYPES, 'Display Types', []],
  [SYSTEM_CONFIG_CATEGORY_IDS.SCREEN_RESOLUTIONS, 'Screen Resolutions', []],
  [SYSTEM_CONFIG_CATEGORY_IDS.REFRESH_RATES, 'Refresh Rates', []],
  [SYSTEM_CONFIG_CATEGORY_IDS.COLORS, 'Colors', []],
  [SYSTEM_CONFIG_CATEGORY_IDS.CAMERA_TYPES, 'Camera Types', []],
...
const SYSTEM_CONFIG_VALUE_IDS = Object.freeze({
  ...
  REQUIREMENT_SCREEN_SIZE: 329,
  REQUIREMENT_MODEL_YEAR: 330,
...
const requirementValues = [
  ...
  ['REQUIREMENT_SCREEN_SIZE', 'screen_size'],
  ['REQUIREMENT_MODEL_YEAR', 'model_year'],
