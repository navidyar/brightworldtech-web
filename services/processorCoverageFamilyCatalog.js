...
const DEFINITIONS = Object.freeze([
  ...
  { brandName: 'Intel', code: 'intel-i9-8th-gen', name: 'Intel i9-8th Gen', description: 'Intel Core i9 8th generation processors.', sortOrder: 37 },
  { brandName: 'Intel', code: 'intel-i9-9th-gen', name: 'Intel i9-9th Gen', description: 'Intel Core i9 9th generation processors.', sortOrder: 38 },
  { brandName: 'Intel', code: 'intel-i9-10th-gen', name: 'Intel i9-10th Gen', description: 'Intel Core i9 10th generation processors.', sortOrder: 39 },
  { brandName: 'Intel', code: 'intel-i9-12th-gen', name: 'Intel i9-12th Gen', description: 'Intel Core i9 12th generation processors.', sortOrder: 40 },
  { brandName: 'Intel', code: 'intel-i9-13th-gen', name: 'Intel i9-13th Gen', description: 'Intel Core i9 13th generation processors.', sortOrder: 41 },
